  ...
  async function handleDelete() {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/ingredients/delete/${ingredientId}?email=${encodeURIComponent(
          email
        )}`,
        { method: "DELETE" }
      );
...
DeleteIngredientDialog.displayName = "DeleteIngredientDialog";
